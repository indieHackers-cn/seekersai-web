...
export default function Features() {
  return (
    <div className="py-20 md:py-24 bg-[#f8fafc] dark:bg-[#0b113a]" id="features">
        <div className="container px-4 mx-auto">
            <div className="w-full lg:w-1/2 2xl:w-1/2 mx-auto text-center">
                <h2 className="heading text-5xl !leading-normal text-black font-bold">Main
                    Features
                </h2>
                <p className="text-gray-500 dark:text-gray-400 text-xl">In the world of seekersai, 
                we will utilize these features to help you find the most suitable remote job requirements that fulfill all your career aspirations.
                </p>
            </div>
            <div className="mt-10">
            <div className="flex flex-col lg:flex-row items-stretch justify-center flex-wrap">
                <div className={f.featuresbox}>
                <div className="py-4 px-1">
                    ...
                    <h3 className="heading text-2xl mb-2 leading-normal text-black">
                        Crafted For Freelancer
                    </h3>
                    <p className="text-base text-gray-500 dark:text-gray-400 opacity-90">A Noah's Ark for freelancers 
                    who are about to enter or have already entered the workplace, where you can find the job you want, develop more comprehensive skills, and enjoy your own beautiful schedule.
                    </p>
                    </div>
                </div>
                </div>
                ...
                <div className="py-4 px-1">
                    <div className="icon-box mb-6">
                    <svg width="60" height="62" viewBox="0 0 40 42" className="mx-auto svg-fill">
                        <path opacity="0.5"
                    ...
                    <div className="text-center">
                        <h3 className="heading text-2xl mb-2 leading-normal text-black">
                        Efficient Intelligent Search
                        </h3>
                        <p className="text-base text-gray-500 dark:text-gray-400 opacity-90">Upload your resume, 
                        you only need to focus on the career you want, 
                        leave the rest to intelligent search, 
                        it will find the best remote jobs in the world for you.
                        </p>
                    </div>
                </div>
                </div>
                ...
                <div className="py-4 px-1">
                    ...
                    <div className="text-center">
                        <h3 className="heading text-2xl mb-2 leading-normal text-black">Score
                            Matching Mechanism
                        </h3>
                        <p className="text-base text-gray-500 dark:text-gray-400 opacity-90">Use optimized ai matching mechanism to professionally score,
                            connecting your skill set with companies that urgently need you, and pushing the most suitable job for you.
                        </p>
                    </div>
                </div>
                </div>
                ...
                <div className="py-4 px-1">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-base text-gray-500 dark:text-gray-400 opacity-90">At current stage, 
                        the strongest support is for PDF files, so integrating your resume into a one or two-page PDF and uploading 
                        it will give you the best experience. More file types will be supported in the future.
                        </p>
                    </div>
                </div>
                </div>
                ...
                <div className="py-4 px-1">
                    <div className="icon-box mb-6">
                        <svg width="60" height="65" viewBox="0 0 40 45" className="mx-auto svg-fill">
                            <path opacity="0.5"
                    ...
                    <p className="text-base text-gray-500 dark:text-gray-400 opacity-90"> No matter where you are, 
                    what you are doing, or what your usual habits are, you can use it in any way to help you retrieve the work you want. 
                    It cannot be a limitation on how you use it.
                    </p>
                    </div>
                </div>
                </div>
                ...
                <div className="py-4 px-1">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-base text-gray-500 dark:text-gray-400 opacity-90">We look forward to meeting more people who like it 
                        and possibly assisting you in polishing your resume. 
                        Our goal is to make sure you have no trouble finding remote work.
                        </p>
                    </div>
                </div>
                </div>
